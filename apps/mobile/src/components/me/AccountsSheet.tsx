            ...
            {organizations.length > 0 ? (
              <View className="flex-row flex-wrap gap-2">
                ...
                {organizations.map((org) => (
                  ...
                  >
                    <Text
                      className={selectedOrgId === org.id ? 'text-accent' : 'text-foreground'}
                    >
                      {org.name}
                    </Text>
                  </Pressable>
            ...
            {!orgMode ? (
              accounts.length === 0 ? (
                <View className="items-center rounded-xl border border-dashed border-border px-6 py-10">
                  ...
                  <Pressable
                    onPress={() => setShowConnect(true)}
                    className="mt-4 rounded-lg bg-accent px-5 py-3"
                  >
                    <Text className="font-semibold text-white">Connect account</Text>
                  </Pressable>
                </View>
              ) : (
              ...
              <View className="items-center rounded-xl border border-dashed border-border px-6 py-10">
                ...
                <Pressable
                  ...
                  className="mt-4 rounded-lg bg-accent px-5 py-3"
                >
                  <Text className="font-semibold text-white">Connect org account</Text>
                </Pressable>
              </View>
            ) : (
