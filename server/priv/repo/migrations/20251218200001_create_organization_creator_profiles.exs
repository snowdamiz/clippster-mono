  ...
  def change do
    ...
    create table(:organization_creator_platform_links) do
      add :organization_creator_profile_id,
          references(:organization_creator_profiles, on_delete: :delete_all), null: false
    ...
    create unique_index(
             :organization_creator_platform_links,
             [:organization_creator_profile_id, :platform, :platform_id],
    ...
    create unique_index(
             ...
             [:organization_creator_profile_id, :user_id],
