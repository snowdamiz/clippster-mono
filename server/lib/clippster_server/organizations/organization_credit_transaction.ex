defmodule ClippsterServer.Organizations.OrganizationCreditTransaction do
  @moduledoc """
  Schema for tracking organization credit purchase transactions.
  Records all payments made to purchase credits for an organization's pool.
  """
  use Ecto.Schema
  import Ecto.Changeset

  schema "organization_credit_transactions" do
    ...
    belongs_to :purchased_by, ClippsterServer.Accounts.User, foreign_key: :purchased_by_user_id
  ...
  @doc """
  Creates a confirmed Solana/crypto transaction
  """
  def solana_changeset(attrs) do
    %__MODULE__{status: "confirmed", payment_method: "solana"}
    |> changeset(attrs)
  end
