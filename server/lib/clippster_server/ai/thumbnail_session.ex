defmodule ClippsterServer.AI.ThumbnailSession do
  use Ecto.Schema
  ...
  schema "ai_thumbnail_sessions" do
    ...
    field :reference_image_url, :string
    field :reference_image_meta, :map
    field :brief_summary, :map
    field :candidates, {:array, :map}, default: []
    field :plate_url, :string
    field :recipe, :map
