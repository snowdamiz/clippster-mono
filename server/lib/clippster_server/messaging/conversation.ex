defmodule ClippsterServer.Messaging.Conversation do
  ...
  @conversation_types ~w(direct group announcement support staff)
  ...
  schema "conversations" do
    ...
    belongs_to :archived_by_user, User, foreign_key: :archived_by_user_id
  ...
  def changeset(conversation, attrs) do
    ...
    |> foreign_key_constraint(:archived_by_user_id)
  end
