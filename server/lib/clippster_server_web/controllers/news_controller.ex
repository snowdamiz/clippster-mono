  ...
  def update(conn, %{"uuid" => uuid} = params) do
    case News.get_news_article(uuid) do
      ...
      article ->
        ...
        update_attrs =
          if Map.has_key?(params, "is_featured"),
            do: Map.put(update_attrs, :is_featured, params["is_featured"]),
            else: update_attrs

        update_attrs =
          if Map.has_key?(params, "relevance_score"),
            do: Map.put(update_attrs, :relevance_score, params["relevance_score"]),
            else: update_attrs
