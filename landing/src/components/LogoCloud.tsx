...
function KickIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      <path d="M1.333 0v24h5.334v-8l2.666 2.667L16 24h6.667L14 15.333 22.667 8H16l-6.667 6.667V0H1.333z"/>
    </svg>
  )
}
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10">
          {platforms.map((platform, index) => (
            <motion.div
              ...
              className="flex items-center gap-2.5 cursor-default transition-all duration-300"
              style={{
                color: hoveredIndex === index ? platform.color : 'rgba(255, 255, 255, 0.4)',
                filter: hoveredIndex === index ? `drop-shadow(0 0 8px ${platform.color}50)` : 'none',
              }}
            >
              <platform.icon />
