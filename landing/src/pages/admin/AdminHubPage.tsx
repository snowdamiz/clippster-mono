      ...
      isAdmin
        ? [
            ...
            },
            {
              id: 'announcements',
              title: 'Announcements',
              description: 'Create and manage in-app announcements for users',
              icon: Megaphone,
              route: `${adminBasePath}/announcements`,
            },
            {
              id: 'messaging',
              title: 'Email Campaigns',
              description: 'Send emails to users, waitlist, or individuals',
              icon: Mail,
              route: `${adminBasePath}/messaging`,
            },
          ]
        : [],
    [adminBasePath, isAdmin],
