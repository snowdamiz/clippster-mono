  ...
  async function handleDelete() {
    ...
    try {
      const res = await api.delete<{ success: boolean }>(
        `/organization-applications/${application.id}`,
      )
      if (res.success) {
        setApplication(null)
        setForm(emptyForm())
      ...
      <div className="min-h-screen bg-[#0a0a0b] flex items-center justify-center p-6">
        <div className="w-full max-w-lg">
          <div className="flex flex-col items-center text-center mb-8">
            <div
              className={`w-16 h-16 rounded-2xl ${status.bg} flex items-center justify-center mb-4`}
            >
      ...
      <div className="w-full max-w-lg">
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-sm text-zinc-500 leading-relaxed max-w-sm">
            Tell us about your organization and how you plan to use Clippster. Applications are
        ...
        <form onSubmit={editing ? handleUpdate : handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            ...
            {fieldErrors.team_size && (
              <p className="text-red-400 text-xs mt-1">{fieldErrors.team_size[0]}</p>
            )}
          </div>
          ...
          <div>
            <label className="block text-sm font-medium text-zinc-400 mb-1.5">
              <span className="flex items-center gap-1.5">
                <FileText className="w-3.5 h-3.5" /> How will you use Clippster? *
              </span>
            </label>
            <textarea
              value={form.use_case}
            ...
            {fieldErrors.use_case && (
              <p className="text-red-400 text-xs mt-1">{fieldErrors.use_case[0]}</p>
            )}
          </div>
          ...
          <div>
            ...
            {fieldErrors.contact_email && (
              <p className="text-red-400 text-xs mt-1">{fieldErrors.contact_email[0]}</p>
            )}
          </div>
