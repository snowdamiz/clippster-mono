        ...
        <ul class="space-y-1">
          ...
          <li>
            <router-link
              to="/dashboard/videos"
              class="nav-link"
              :class="{ 'nav-link-active': isActive('/dashboard/videos') }"
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <main class="flex-1 ml-64">
      ...
      <header class="h-16 px-8 flex items-center justify-between border-b border-border/40 bg-background">
        ...
        <div class="relative">
          ...
          <input type="text" placeholder="Search..." class="pl-9 pr-4 py-2 mr-[-18px] bg-background border border-border rounded-lg focus:outline-none focus:border-foreground/30 w-64 text-sm">
        </div>
      </header>
