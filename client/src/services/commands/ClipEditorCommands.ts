...
export class SplitCommand extends BaseCommand {
  ...
  async execute(): Promise<void> {
    if (this.editorMode) {
      ...
      console.log('[SplitCommand] Editor mode split - will be implemented with splitVideoSource integration');
      ...
      console.log(`[SplitCommand] Split complete, segments: ${this.data.beforeSegments.length} → ${this.data.afterSegmentCount}`);
    }
  }
  ...
  async undo(): Promise<void> {
    if (this.editorMode) {
      // Editor mode undo
      console.log('[SplitCommand] Editor mode undo - will be implemented with splitVideoSource integration');
      ...
      console.log('[SplitCommand] Undoing split - restoring', this.data.beforeSegments.length, 'segments');
      ...
      console.log('[SplitCommand] Restoring original segment times at index', this.data.segmentIndex);
...
export class DeleteCommand extends BaseCommand {
  ...
  async execute(): Promise<void> {
    if (this.editorMode) {
      ...
      console.log('[DeleteCommand] Editor mode delete - will be implemented with video editor integration');
  ...
  async undo(): Promise<void> {
    if (this.editorMode) {
      // Editor mode undo
      console.log('[DeleteCommand] Editor mode undo - will be implemented with video editor integration');
      throw new Error('Editor mode undo not yet integrated');
    } else {
...
export class PasteCommand extends BaseCommand {
  ...
  async undo(): Promise<void> {
    if (this.editorMode) {
      ...
      console.log('[PasteCommand] Undoing paste - deleting segment at index', this.data.pastedSegmentIndex);
