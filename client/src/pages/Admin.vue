              ...
              <tr v-for="user in users" :key="user.id" class="hover:bg-muted/20 transition-colors">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                  <div class="flex flex-col space-y-1">
                    <div class="flex items-center">
                      <svg
                        v-if="user.credits?.hours_remaining === 'unlimited'"
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-3 w-3 mr-1 text-purple-500"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
                      ...
                      <span v-if="user.credits?.hours_remaining !== 'unlimited'" class="text-muted-foreground ml-1">
                        hours
                      </span>
                      <span v-else class="text-purple-500 ml-1 font-medium">Unlimited</span>
                    </div>
                    <div
                      v-if="user.credits?.hours_remaining !== 'unlimited'"
                    ...
                    <div v-else class="flex items-center text-xs text-purple-500">
