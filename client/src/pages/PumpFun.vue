  ...
  >
    ...
    <div v-if="loading" class="space-y-6">
      ...
      <div class="flex items-center justify-center gap-3">
        ...
        <button
          disabled
          class="px-5 py-2.5 bg-gradient-to-br from-purple-500/80 to-indigo-500/80 text-white rounded-lg flex items-center gap-2 font-medium shadow-sm transition-all opacity-50 cursor-not-allowed"
        >
