<template>
  <div>
    ...
    <div class="space-y-4">
      <!-- Sample Prompt Cards -->
      <div v-for="i in 8" :key="i" class="bg-card border border-border rounded-lg p-5 hover:shadow-lg transition-all">
        <div class="flex items-start justify-between mb-3">
          <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
              <h3 class="font-semibold text-foreground mb-1">Prompt Template {{ i }}</h3>
              <p class="text-sm text-muted-foreground line-clamp-2">
                This is a sample prompt template that helps you create engaging video content with AI assistance. 
                It includes various parameters and instructions for optimal results.
              </p>
            </div>
          </div>
          <div class="flex items-center gap-2">
            <button class="p-1.5 hover:bg-accent rounded transition-colors">
