<template>
  <div class="editor-inspector">
    ...
    <div class="editor-inspector__content">
      <div v-if="!selectedItem" class="editor-inspector__empty">
        <Info :size="32" class="editor-inspector__empty-icon" />
        <p class="editor-inspector__empty-text">
          Select an item on the timeline to view its properties
        </p>
      </div>

      <div v-else class="editor-inspector__properties">
...
.editor-inspector__empty-icon {
  color: rgba(255, 255, 255, 0.3);
}

.editor-inspector__empty-text {
