<template>
  <div class="speed-curve-editor">
    ...
    <div class="flex items-center justify-between">
      ...
      <button @click="$emit('close')" class="p-1 rounded hover:bg-white/10 transition-colors" title="Close">
    ...
    <div class="relative">
      ...
      <div
        class="absolute left-1 top-0 bottom-0 flex flex-col justify-between text-[9px] text-white/40 pointer-events-none py-1"
      >
        <span>4x</span>
        <span>2x</span>
        <span>1x</span>
      ...
      <div
        class="absolute left-4 right-0 bottom-0 flex justify-between text-[9px] text-white/40 pointer-events-none px-1"
      >
        <span>0s</span>
    ...
    <div class="space-y-1 max-h-32 overflow-y-auto">
      <div
        ...
        :class="
          selectedKeyframeId === kf.id ? 'bg-orange-500/20 border border-orange-500/50' : 'bg-white/5 hover:bg-white/10'
        "
