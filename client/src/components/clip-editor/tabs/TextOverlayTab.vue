            ...
            <div>
              ...
              <div class="flex items-center gap-1">
                <input
                  ...
                  @input="(e) => updatePosition(parseInt((e.target as HTMLInputElement).value), getPositionForRatio(overlay).y)"
                  min="0"
                  max="100"
                ...
                <input
                  ...
                  @input="(e) => updatePosition(getPositionForRatio(overlay).x, parseInt((e.target as HTMLInputElement).value))"
                  min="0"
                  max="100"
                  class="w-1/2 px-2 py-2 bg-white/5 border border-white/10 rounded-md text-sm text-white"
                  title="Y position (%)"
