<template>
  ...
  >
    <!-- Track Label -->
    <div class="w-16 h-8 pr-2 flex items-center justify-center sticky left-0 z-30 bg-[#101010] backdrop-blur-sm">
...
<script setup lang="ts">
  import { ref } from 'vue'
  import { formatDuration, generateClipGradient, getSegmentDisplayTime, type ClipSegment } from '../utils/timelineUtils'
