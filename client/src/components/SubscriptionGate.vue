...
<script setup lang="ts">
  ...
  const tiers = ref([
    { id: 'starter', name: 'Starter', price_usd: 20, monthly_credits: 600 },
    { id: 'creator', name: 'Creator', price_usd: 50, monthly_credits: 1800 },
    { id: 'pro', name: 'Pro', price_usd: 200, monthly_credits: 9000 },
  ]);
